...
<p align="center">
  <a href="https://github.com/LuckyZ10/TypX/releases/download/v0.9.5/TypX-Setup-0.9.5.exe"><strong>⬇️ 下载 Windows 安装包 / Download v0.9.5</strong></a>
  &nbsp;·&nbsp;
...
1. 下载 [`TypX-Setup-0.9.5.exe`](https://github.com/LuckyZ10/TypX/releases/download/v0.9.5/TypX-Setup-0.9.5.exe)（Windows 10/11，64 位）。
2. 运行安装向导并选择安装目录。
...
1. Download [`TypX-Setup-0.9.5.exe`](https://github.com/LuckyZ10/TypX/releases/download/v0.9.5/TypX-Setup-0.9.5.exe) (Windows 10/11, 64-bit).
